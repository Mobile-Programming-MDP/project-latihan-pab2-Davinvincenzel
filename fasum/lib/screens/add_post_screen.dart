...
class _AddPostScreenState extends State<AddPostScreen> {
  ...
  Future<void> _generateDescriptionWithAI() async {
    ...
    try {
      ...
      final model = GenerativeModel(
        ...
        apiKey:
            'AIzaSyB76auTp0UqnN4qofbvgVL-xtgEV0vfMpk', //gunakan api key gemini anda
        //requestOptions: ro,
      );
  ...
  Future<void> sendNotificationToTopic(String body, String senderName) async {
    final url = Uri.parse(
        'https://fasum-cloud-lemon.vercel.app/send-to-topic'); //ganti dengan url vercel masing-masing
